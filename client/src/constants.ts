...
export const TRANSLATIONS = {
  'zh-TW': {
    ...
    // Location Page
    locationTitle: '我的位置',
    locationSubtitle: '開啟定位來探索附近景點',
    enableLocation: '開啟定位',
    refreshLocation: '更新位置',
    locating: '定位中...',
    ...
    lastUpdate: '上次更新',
    nearbyPlaces: '附近景點',
    noLocationPermission: '請允許存取您的位置',
  ...
  'en': {
    ...
    locationSubtitle: 'Enable location to explore nearby places',
    ...
    noLocationPermission: 'Please allow location access',
  ...
  'ja': {
    ...
    // Location Page
    locationTitle: '現在地',
    locationSubtitle: '位置情報を有効にして周辺スポットを探索',
    enableLocation: '位置情報を有効にする',
    refreshLocation: '位置を更新',
    locating: '位置取得中...',
    locationEnabled: '位置情報が有効です',
    accuracy: '精度',
    meters: 'メートル',
    lastUpdate: '最終更新',
    nearbyPlaces: '周辺スポット',
    noLocationPermission: '位置情報へのアクセスを許可してください',
    locationError: '位置を取得できません',
    tryAgain: '再試行',
    // Merchant
  ...
  'ko': {
    ...
    // Location Page
    locationTitle: '내 위치',
    locationSubtitle: '위치를 활성화하여 주변 명소 탐색',
    enableLocation: '위치 활성화',
    refreshLocation: '위치 새로고침',
    locating: '위치 확인 중...',
    locationEnabled: '위치 활성화됨',
    accuracy: '정확도',
    meters: '미터',
    lastUpdate: '마지막 업데이트',
    nearbyPlaces: '주변 명소',
    noLocationPermission: '위치 액세스를 허용해주세요',
